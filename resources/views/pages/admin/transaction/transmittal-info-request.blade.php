        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <button type="button" class="btn btn-block bg-deep-orange waves-effect left" onclick="window.document.location='{{ URL::asset('admin/transaction/transmittal-request') }}';" >
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                    <ol class="breadcrumb breadcrumb-bg-pink align-right">
                        ...
                        <li><a href="{{ URL::asset('admin/transaction/transmittal-request') }}"><i class="material-icons">library_books</i> Transmittal Requests</a></li>
                        <li><a href="javascript:void(0);"><i class="material-icons">library_books</i> Transmittal Request Details</a></li>
                    </ol>
                </div>
            </div>
        <div class="row clearfix">
