        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    <button type="button" class="btn btn-block bg-deep-orange waves-effect left" onclick="window.document.location='{{ URL::asset('admin/transaction/insurance-expiring-accounts-company') }}';" >
                    ...
                    <div class="card">
                        ...
                        <h3 style="text-align: center;"><img src="{{ URL::asset ('images/icons/sent.png')}}" style="height: 50px; width: 50px;"> Sent Notifications</h3>
                            <ul class="header-dropdown m-r--5">
                                <li><button type="button" class="btn bg-gray waves-effect right" style="position: right;" onclick="window.document.location='{{ URL::asset('admin/transaction/insurance-settings-company') }}';" data-toggle="tooltip" data-placement="bottom" title="Settings">
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>FPG Insurance</td>
                                        <td>Mar-11-2017</td>
                                        <td><button type="button" class="btn bg-light-blue waves-effect" onclick="window.document.location='{{ URL::asset('admin/transaction/insurance-details-company') }}';" data-toggle="tooltip" data-placement="left" title="View account details."><i class="material-icons">remove_red_eye</i>
                                                </button></td>
                                    </tr>
                                </tbody>
                            </table>
