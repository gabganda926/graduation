                    ...
                    <div class="card">
                        ...
                        <h3 style="text-align: center;"><img src="{{ URL::asset ('images/icons/insurance-company.png')}}" style="height: 50px; width: 50px;"> Insurance Accounts - Company Client</h3>
                            <ul class="header-dropdown m-r--5">
                                <li><button type="button" class="btn bg-red waves-effect right" style="position: right;" onclick="window.document.location='{{ URL::asset('admin/transaction/insurance-expiring-accounts-company') }}';" data-toggle="tooltip" data-placement="bottom" title="View expiring accounts">
                        ...
                        <form id = "gen_comp" action = "/pdf/insurance/form/company" method = "GET" style = "display: none;">
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              <div class="col-md-4" style = "display: none;">
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                              @foreach($paydetails as $spay)
                                               ...
                                               <button form = "gen_comp" type="submit"  class="btn bg-orange waves-effect" style="position: right;" data-toggle="tooltip" data-placement="left" title="Generate Form" data-id = "{{ $ccompany->comp_ID }}" data-acc = "{{$iacc->account_ID}}" data-pay = "{{$spay->payment_ID}}" onclick="
