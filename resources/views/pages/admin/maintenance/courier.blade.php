                ...
                <div class="modal-dialog modal-lg animated zoomInLeft active" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="add" name = "add" action = "courier/submit" method="POST" enctype="multipart/form-data">
            ...
            <div class="collapse fade" id="largeModal" role="dialog">
                <div class="modal-dialog modal-lg animated zoomInRight active" role="document">
                    <div class="modal-content">
                        ...
                        onclick = "
                        document.getElementById('view').action = 'courier/update';
                        ...
                        onclick = "
                        document.getElementById('view').action = 'courier/delete';
                                          ...
                                          @foreach($address as $add)
                                           @if($add->add_ID == $cdata->courier_add_ID)
                                            <tr>
                                                ...
                                                data-source = '{!! "/image/courier/".$pnfo->pinfo_picture !!}'
