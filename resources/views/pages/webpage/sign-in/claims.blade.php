                ...
                <!-- PAG PINILI YUNG COMPANY -->
                    ...
                    <div>
                        ...
                        <div class="col-xs-12">
                                ...
                                <select id="1" data-size="10" data-width="100%" style="width: 100%">
                                <option value="1">Company1</option>
                                <option value="2">Company2</option>
                                <option value="3">Company3</option>
                            </select>
                    ...
                    <div>
                        ...
                        <div class="col-xs-12">
                            <div class="sky_form1 col col-xs-12">
                                <ul>
                                    <br/><li><label class="radio left"><input type="radio" name="radio" onclick="
                                    $('#rep').hide(800);"><i></i>Policy holder&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></li>
                                    <li><label class="radio"><input type="radio" name="radio" onclick="
                                    $('#rep').show(800);"><i></i>Representative of Policy holder</label></li><br/><br/>
                                    <div class="clearfix"></div>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="col-xs-12">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        <th class="col-md-7"><small>Requirement</small></th>
                                        <th class="col-md-5"><small>Files</small></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td><small>Photographs of the damaged vehicle </small></td>
                                        <td><input type="file" name="filez" id="filez">
                                        <button type="button" class="btn btn-xs bg-gray waves-effect" onclick="">
                                                    <i class="material-icons">add</i>
                                                    <span>Add more file</span> <!-- PAG KINLICK, MADADAGDAGAN UNG UPLOAD NA BUTTON -->
                                                </button></td>
                                    </tr>

                                    <tr>
                                        <td><small>Third Property Damage to Vehicle </small></td>
                                        <td><input type="file" name="filez" id="filez">
                                        <button type="button" class="btn btn-xs bg-gray waves-effect" onclick="">
                                                    <i class="material-icons">add</i>
                                                    <span>Add more file</span> <!-- PAG KINLICK, MADADAGDAGAN UNG UPLOAD NA BUTTON -->
                        ...
                        <div class="col-xs-12">
                            <br/><button type="button" class="btn btn-block btn-primary" onclick="window.open('{{ URL::asset('/user/claim/requirements') }}')">View claim requirements</button>
                        </div>
