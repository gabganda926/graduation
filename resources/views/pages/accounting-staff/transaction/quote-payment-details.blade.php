            ...
            <div class="row clearfix">
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                    <div class="card" id="cov">
                        ...
                        <div class="body">
                            <form id="form_data" name = "form_data" class = "form_data" action = '../quotation-list/submit' method="POST">
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                 ...
                                 <div class="col-md-4" style = "display: none;">
                                    <input id = "quote_ID" name = "quote_ID" type="text" class="form-control" value="{{$quote_ID}}">
                                 </div>
