...
<html>
	...
	<body>
        ...
        <p><strong><input type="text" style="border: none; font-size: 15px; width: 400px;" value="Client:  {{ $inf->pinfo_last_name }}, {{ $inf->pinfo_first_name }}"></strong><b><input type="text" style="border: none; font-size: 15px; width: 400px;" value="Bill Number:  @if($cv->cv_ID >= 10)
			                                                BILL00{{ $cv->cv_ID }}
			                                            @endif
			                                            @if($cv->cv_ID < 10)
			                                                BILL000{{ $cv->cv_ID }}
