...
<html>
	...
	<body>
        ...
        <p style="color:black; text-align: center; font-size:20px;"><strong>Sales Report - {{ $icomp->comp_name }}</strong></p>
        ...
        <table width="100%" id="particulars">
        	...
        	<tbody>
        		...
        		@if($list->Company == $icomp->comp_ID)
	        		<tr>
		        		<td class="center">
		        			{{ \Carbon\Carbon::parse($list->Day)->format("M-d-Y") }} 
		        			{{ "(".\Carbon\Carbon::parse($list->Day)->format("l, h:i:s A").")" }}
		        		</td>
		        		<td class="center">
