...
<head>
    ...
    <title>Maintenance - Client Type | CIMIS</title>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                  ...
                                  @foreach($clienttype as $ctype)
                                    @if($ctype->del_flag == 0)
                                        <tr>
                                            <td><input type="checkbox" id="{{ $ctype->clientType_ID }}" name = "del_check" class="filled-in chk-col-red checkCheckbox"/>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input id = "clientType_desc" name = "clientType_desc" type="text" class="form-control" name="name" required>
            ...
            <div class="modal fade" id="largeModal" tabindex="-1" role="dialog">
                <div class="modal-dialog animated zoomInRight active" role="document">
                    <div class="modal-content">
                                     ...
                                     <div class="col-md-12">
                                            <div class="form-group form-float">
                                                ...
                                                <label><small>Description :</small></label>
                                                    <input id = "aclientType_desc" name = "aclientType_desc" type="text" class="form-control" name="name" disabled="disable" required>
                                                </div>
                                            </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer js-sweetalert">
                            <button id = "schange" style = "display: none;" class="btn btn-primary waves-effect" type="submit" onclick = "document.getElementById('atime').value = formatDate(new Date());">SAVE CHANGES</button>
                            <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                        </div>
                    </form>
                    </div>
