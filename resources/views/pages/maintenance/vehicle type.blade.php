...
<head>
    ...
    <title>Maintenance - Vehicle Type | CIMIS</title>
    <!-- Favicon-->
                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                    ...
                                    @if($type->del_flag == 0)
                                    <tr>
                                      <td><input type="checkbox" id="{{ $type->vehicle_type_ID }}" class="filled-in chk-col-red"/>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="smallModalLabel">UPDATE VEHICLE TYPE</h4>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer js-sweetalert">
                            <button class="btn btn-primary waves-effect" data-type="cancel">SAVE CHANGES</button>
                            <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                        </div>
                    </div>
                </div>
