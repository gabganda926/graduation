...
<head>
    ...
    <title>Maintenance - Quote Status | CIMIS</title>
...
<body class="theme-teal">
    ...
    <section class="content">
        <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <li>
                                <button type="button" class="btn bg-blue waves-effect" data-toggle="modal" data-target="#addQStatModal">
                                    <i class="material-icons">add_circle_outline</i>
                                    <span>Add Quote Status</span>
                                </button>
                                </li>
                                <li>
                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                ...
                                <tbody>
                                        @foreach($qot as $quote)
                                          @if($quote->del_flag == 0)
                                          <tr>
                                            <td><input type="checkbox" id="{{ $quote->quoteStatus_ID }}" name = "del_check" class="filled-in chk-col-red checkCheckbox"/>
                                            <label for="{{ $quote->quoteStatus_ID }}"></label></td>
                                            <td>{{ $quote->quoteStatus_name }}</td>
                                            <td>{{ \Carbon\Carbon::parse($quote->created_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($quote->created_at)->format('l, h:i:s A').")" }}</td>
                                            <td>{{ \Carbon\Carbon::parse($quote->updated_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($quote->updated_at)->format('l, h:i:s A').")" }}</td>
                                            <td>
                                            <button type="button" class="btn bg-light-blue waves-effect" data-toggle="modal" data-target="#largeModal"
                                            data-id = "{{ $quote->quoteStatus_ID }}"
                                            data-name = "{{ $quote->quoteStatus_name }}"
                                            data-desc = "{{ $quote->quoteStatus_desc }}"
                                            onclick= "

                                            document.getElementById('id').value = $(this).data('id');
                                            document.getElementById('aqstat_name').value = $(this).data('name');
                                            document.getElementById('aqstat_desc').value = $(this).data('desc');
                                            ">
            ...
            <!-- ADD INST MODAL -->
            <div class="modal fade" id="addQStatModal" tabindex="-1" role="dialog">
                <div class="modal-dialog animated zoomInLeft active" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-add">
                            <h4><br/>Add Quote Status</h4>
                        </div><br/><br/>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input id = "qstat_name" type="text" class="form-control" name="qstat_name" required>
                                                <label class="form-label">Quote Status Name </label>
                                            </div>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input id = "qstat_desc" type="text" class="form-control" name="qstat_desc" required>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                            <label><small>Quote Status Name :</small></label>
                                                <input id = "aqstat_name" type="text" class="form-control" name="aqstat_name" disabled="disable" required>
                                            </div>
                                        </div>
                                </div>
                                 ...
                                 <div class="col-md-12">
                                        <div class="form-group form-float">
                                            ...
                                            <label><small>Description :</small></label>
                                                <input id = "aqstat_desc"type="text" class="form-control" name="aqstat_desc" disabled="disable" required>
                                            </div>
                                        </div>
                                </div>
                            </div>
