...
<head>
    ...
    <title>Maintenance - Policy Number | CIMIS</title>
    <!-- Favicon-->
                                      ...
                                      @foreach($com as $company)
                                        @if($pnumber->insurance_compID == $company->comp_ID)
                                         @foreach($stat as $stats)
                                          @if($pnumber->policyStatus_ID == $stats->policyStatus_ID)
                                          <tr>
                                              <td><input type="checkbox" id="{{ $pnumber->policy_number }}" name = "del_check" class="filled-in chk-col-red checkCheckbox"/>
                                              <label for="{{ $pnumber->policy_number }}"></label></td>
                                              <td>{{ $pnumber->policy_number }}</td>
                                              <td>{{ $company->comp_name }}</td>
                                              <td>{{ $stats->policyStatus_name }}</td>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-12">
                                        <select id = "statdrop" name = "statdrop" class="form-control show-tick" data-live-search="true">
                                            ...
                                            @foreach($stat as $stats)
                                            @if($stats->del_flag == 0)
                                                <option value = "{{ $stats->policyStatus_ID }}">{{ $stats->policyStatus_name }}</option>
                                            @endif
                                            @endforeach
                                        </select>
                                    </div>
