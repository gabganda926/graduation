...
<head>
    ...
    <title>Maintenance - Complaint Status | CIMIS</title>
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                ...
                                <button type="button" class="btn bg-blue waves-effect" data-toggle="modal" data-target="#addModal">
                                    ...
                                    <span>Add Complaint Status</span>
                                </button>
                                </li>
                                <li>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                     <?php
                                        $index = 1;
                                      ?>
                                      @foreach($complaintstatus as $cstatus)
                                      @if($cstatus->del_flag == 0)
                                          <tr>
                                              <td><input type="checkbox" id="{{ $cstatus->complaintStatus_ID }}" name = "del_check" class="filled-in chk-col-red checkCheckbox"/>
                                              <label for="{{ $cstatus->complaintStatus_ID }}"></label></td>
                                              <td>{{ $cstatus->complaintStatus_name }}</td>
                                              <td>{{ \Carbon\Carbon::parse($cstatus->created_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($cstatus->created_at)->format('l, h:i:s A').")" }}</td>
                                              <td>{{ \Carbon\Carbon::parse($cstatus->updated_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($cstatus->updated_at)->format('l, h:i:s A').")" }}</td>
                                              <td>
                                                <div class="icon-button-demo">
                                                    <button type="button" class="btn bg-light-blue waves-effect" data-toggle="modal" data-target="#largeModal"
                                                    data-id = "{{ $cstatus->complaintStatus_ID }}"
                                                    data-name = "{{ $cstatus->complaintStatus_name }}"
                                                    data-desc = "{{ $cstatus->complaintStatus_desc }}"
                                                    onclick= "

                                                    document.getElementById('id').value = $(this).data('id');
                                                    document.getElementById('acomplaintStatus_name').value = $(this).data('name');
                                                    document.getElementById('acomplaintStatus_desc').value = $(this).data('desc');
                                                    ">
                ...
                <div class="modal-dialog animated zoomInLeft active" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-add">
                            <h4><br/>Add Complaint Status</h4>
                        </div><br/><br/>
                        <div class="modal-body">
                            <form id="add" name = "add" action = "status/submit" method="POST">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input id = "complaintStatus_name" name = "complaintStatus_name" type="text" class="form-control" required>
                                                <label class="form-label">Complaint Status Name </label>
                                            </div>
                                            <div class="help-info">Ex.: Verified, Action ongoing, etc.</div>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input id = "complaintStatus_desc" name = "complaintStatus_desc" type="text" class="form-control" required>
                ...
                <div class="modal-dialog animated zoomInRight active" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-view">
                            <h4><br/>Complaint Status Details
                            </h4>
                        </div><br/>
                        <button id = "Edit" style = "margin-left: 32em" type="button" class="btn btn-success btn-lg waves-effect"
                          onclick = "
                          document.getElementById('view').action = 'status/update';
                          $('#Edit').prop('disabled', true);
                          $('#Delete').prop('disabled', false);
                          $('#schange').show();
                          $('#acomplaintStatus_name').prop('disabled', false);
                          $('#acomplaintStatu_desc').prop('disabled', false);
                          ...
                          onclick = "
                          document.getElementById('view').action = 'status/delete';
                          $('#Edit').prop('disabled', false);
                          $('#Delete').prop('disabled', true);
                          $('#schange').show();
                          $('#acomplaintStatus_name').prop('disabled', false);
                          $('#acomplaintStatus_desc').prop('disabled', false);
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                            <label><small>Complaint Status Name :</small></label>
                                                <input id = "acomplaintStatus_name" name = "acomplaintStatus_name" type="text" class="form-control" disabled="disable" required>
                                            </div>
                                        </div>
                                </div>
                                 ...
                                 <div class="col-md-12">
                                        <div class="form-group form-float">
                                            ...
                                            <label><small>Description :</small></label>
                                                <input id = "acomplaintStatus_desc" name = "acomplaintStatus_desc" type="text" class="form-control" disabled="disable" required>
                                            </div>
                                        </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer js-sweetalert">
                            <button class="btn btn-primary waves-effect" style = "display: none;" type="submit" onclick = "document.getElementById('atime').value = formatDate(new Date());">SAVE CHANGES</button>
                            <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                        </div>
                    </form>
                    </div>
