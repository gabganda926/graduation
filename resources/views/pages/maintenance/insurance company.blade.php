...
<head>
    ...
    <title>Maintenance - Insurance Company | CIMIS</title>
    <!-- Favicon-->
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <li>
                                <button type="button" class="btn bg-blue waves-effect" data-toggle="modal" data-target="#addCompModal">
                                    <i class="material-icons">business</i>
                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                  ...
                                  ?>
                                      <tr>
                                          <td><input type="checkbox" id="md_checkbox_21" class="filled-in chk-col-red checkCheckbox"/>
                ...
                <div class="modal-dialog modal-lg animated zoomInLeft active" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-add">
                            <h4><br/>Add Insurance Company</h4>
                        </div><br/><br/>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input id = "comp_name" name = "comp_name" type="text" class="form-control" name="name" pattern="[A-Za-z'-]" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <input id = "cPerson_first_name" name = "cPerson_first_name" type="text" class="form-control" pattern="[A-Za-z'-]">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                             <label class="form-label">Middle Name</label>
                                                <input id = "cPerson_middle_name" name = "cPerson_middle_name" type="text" class="form-control" pattern="[A-Za-z'-]">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                             <label class="form-label">Last Name</label>
                                                <input id = "cPerson_last_name" name = "cPerson_last_name" type="text" class="form-control" pattern="[A-Za-z'-]">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="comp_view" name = "comp_view" method="POST">
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              <div class="col-md-4" style = "display: none;">
                                  <input id = "acopid" name = "acopid" type="text" class="form-control">
                              </div>
                                <br/>
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            ...
                                            <label><small>Company Name :</small></label>
                                                <input id = "acomp_name" name = "acomp_name" type="text" class="form-control" name="name" pattern="[A-Za-z'-]" disabled="disable">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                      ...
                                      <div class="col-md-4" style = "display: none;">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <input id = "acPerson_first_name" name = "acPerson_first_name" type="text" class="form-control" disabled="disable" pattern="[A-Za-z'-]">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                             <label><small>Middle Name :</small></label>
                                                <input id = "acPerson_middle_name" name = "acPerson_middle_name" type="text" class="form-control" disabled="disable" pattern="[A-Za-z'-]">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                             <label><small>Last Name :</small></label>
                                                <input id = "acPerson_last_name" name = "acPerson_last_name" type="text" class="form-control" disabled="disable" pattern="[A-Za-z'-]">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-float">
                                            ...
                                            <label><small>Contact Number :</small></label>
                                                <input id = "acPerson_contact" name = "acPerson_contact" type="text" class="form-control"  disabled="disable">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            ...
                                            <label><small>E-mail :</small></label>
                                                <input id = "acPerson_email" name = "acPerson_email" type="email" class="form-control"  disabled="disable">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-body">
                            <form id="vmodel_view" method="POST">
                              <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                ...
                                <tbody>
                                  <tr>
                                    <td><b>MCAR-2034-90<b></td>
                                    </td>
                                    <td>December 03, 2016 (Wednesday, 7:02PM)</td>
                                    <td>January 02, 2017 (Monday, 12:20PM)</td>
                                  </tr>
                                </tbody>
                            </table>
                                <br/><br/><br/>
