...
<head>
    ...
    <title>Maintenance - Installment Type | CIMIS</title>
    <!-- Favicon-->
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                  ...
                                  @if($install->del_flag == 0)
                                      <tr>
                                          <td><input type="checkbox" id="{{ $install->installment_ID }}" name = "del_check" class="filled-in chk-col-red checkCheckbox"/>
                              ...
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input id = "installment_desc" name = "installment_desc" type="text" class="form-control" minlength="5" maxlength="35">
                                                <label class="form-label">Description</label>
                                            </div>
                                            <div class="help-info">Ex.: for 3 months</div>
                                        </div>
                                    </div>
                                </div>
                                <br/><br/><br/>
                ...
                <div class="modal-dialog animated zoomInRight active" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-view">
                          ...
                          onclick = "
                          document.getElementById('instype_view').action = 'type/update';
                          ...
                          onclick = "
                          document.getElementById('instype_view').action = 'type/delete';
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            ...
                                            <label><small>Description :</small></label>
                                                <input id = "ainstallment_desc" name = "ainstallment_desc" type="text" class="form-control" disabled="disable">
                                            </div>
                                        </div>
                                    </div>
                                </div>
