...
<head>
    ...
    <title>Maintenance - Employee Type | CIMIS</title>
    <!-- Favicon-->
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                  <?php
                                      $index = 1;
                                  ?>
                                  @foreach($emptype as $emp)
                                  @if($emp->del_flag == 0)
                                      <tr>
                                          <td><input type="checkbox" id="{{ $emp->emptype_ID }}" name = "del_check" class="filled-in chk-col-red checkCheckbox"/>
                                          <label for="{{ $emp->emptype_ID }}"></label></td> <!--YUNG ID DAPAT NAG IIBA EVERY RECORD -->
                                          <td>{{ $emp->emptype_Name }}</td>
                                          <td><div class="icon-button-demo">
                                            ...
                                            table.column(3).search({{ $emp->emptype_ID }}).draw();">
                                          ...
                                          <td>
                                            <div class="icon-button-demo">
                                                ...
                                                data-id = "{{ $emp->emptype_ID }}"
                                                data-name = "{{ $emp->emptype_Name }}"
                                                data-desc = "{{ $emp->emptype_Desc }}"
                                                onclick= "
                              ...
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input id = "EmployeeType_desc" name = "EmployeeType_desc" type="text" class="form-control" required>
                              ...
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                <label><small>Employee Type Name :</small></label>
                                     ...
                                     <div class="col-md-12">
                                            <div class="form-group form-float">
                                                ...
                                                <label><small>Description :</small></label>
                                                    <input id = "aEmployeeType_desc" name = "aEmployeeType_desc" type="text" class="form-control" disabled="disable" required>
                                                </div>
                                            </div>
                                    </div>
                                </div>
