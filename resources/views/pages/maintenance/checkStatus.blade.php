...
<head>
    ...
    <title>Maintenance - Check Status | CIMIS</title>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                  <?php
                                      $index = 1;
                                  ?>
                                  @foreach($checkstat as $check)
                                  @if($check->del_flag == 0)
                                      <tr>
                                          <td><input type="checkbox" id="{{ $check->checkStatus_ID }}" name = "del_check" class="filled-in chk-col-red checkCheckbox"/>
                                          <label for="{{ $check->checkStatus_ID }}"></label></td>
                                          <td>{{ $check->checkStatus_name }}</td>
                                          <td>{{ \Carbon\Carbon::parse($check->created_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($check->created_at)->format('l, h:i:s A').")" }}</td>
                                          <td>{{ \Carbon\Carbon::parse($check->updated_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($check->updated_at)->format('l, h:i:s A').")" }}</td>
                                          <td>
                                            <div class="icon-button-demo">
                                                <button type="button" class="btn bg-light-blue waves-effect" data-toggle="modal" data-target="#largeModal"
                                                data-id = "{{ $check->checkStatus_ID }}"
                                                data-name = "{{ $check->checkStatus_name }}"
                                                data-desc = "{{ $check->checkStatus_desc }}"
                                                onclick= "

                                                document.getElementById('id').value = $(this).data('id');
                                                document.getElementById('acheckStatus_name').value = $(this).data('name');
                                                document.getElementById('acheckStatus_desc').value = $(this).data('desc');
                                                ">
                ...
                <div class="modal-dialog animated zoomInLeft active" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-add">
                            <h4><br/>Add Cheque Status</h4>
                        </div><br/><br/>
                        <div class="modal-body">
                            <form id="check_add" name = "check_add" action = "status/submit" method="POST">
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input id = "checkStatus_name" name = "checkStatus_name" type="text" class="form-control" required>
                                                    <label class="form-label">Cheque Status Name </label>
                                                </div>
                                            </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input id = "checkStatus_desc" name = "checkStatus_desc" type="text" class="form-control" required>
            ...
            <!-- View INST MODAL-->
                ...
                <div class="modal-dialog animated zoomInRight active" role="document">
                    <div class="modal-content">
                        ...
                        onclick = "
                        document.getElementById('check_view').action = 'status/delete';
                        ...
                        <br/>
                        <div class="modal-body">
                            <form id="check_view" name = "check_view" method="POST">
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <div class="col-md-4" style = "display: none;">
                                  ...
                                  <div class="row clearfix">
                                      <div class="col-md-12">
                                              <div class="form-group form-float">
                                                  <div class="form-line">
                                                  <label><small>Cheque Status Name :</small></label>
                                                      <input id = "acheckStatus_name" name = "acheckStatus_name" type="text" class="form-control" disabled="disable" required>
                                                  </div>
                                              </div>
                                      </div>
                                       ...
                                       <div class="col-md-12">
                                              <div class="form-group form-float">
                                                  ...
                                                  <label><small>Description :</small></label>
                                                      <input id = "acheckStatus_desc" name = "acheckStatus_desc" type="text" class="form-control" disabled="disable" required>
                                                  </div>
                                              </div>
                                      </div>
                                  </div>
