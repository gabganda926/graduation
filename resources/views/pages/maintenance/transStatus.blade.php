...
<head>
    ...
    <title>Maintenance - Transmittal Status | CIMIS</title>
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                ...
                                <button type="button" class="btn bg-blue waves-effect" data-toggle="modal" data-target="#addModal">
                                    ...
                                    <span>Add Transmittal Status</span>
                                </button>
                                </li>
                                <li>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                      <?php
                                        $index = 1;
                                      ?>
                                      @foreach($transtat as $trans)
                                      @if($trans->del_flag == 0)
                                          <tr>
                                              <td><input type="checkbox" id="{{ $trans->transmittalStatus_ID }}" name = "del_check" class="filled-in chk-col-red checkCheckbox"/>
                                              <label for="{{ $trans->transmittalStatus_ID }}"></label></td>
                                              <td>{{ $trans->transmittalStatus_name }}</td>
                                              <td>{{ \Carbon\Carbon::parse($trans->created_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($trans->created_at)->format('l, h:i:s A').")" }}</td>
                                              <td>{{ \Carbon\Carbon::parse($trans->updated_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($trans->updated_at)->format('l, h:i:s A').")" }}</td>
                                              <td>
                                                <div class="icon-button-demo">
                                                    <button type="button" class="btn bg-light-blue waves-effect" data-toggle="modal" data-target="#largeModal"
                                                    data-id = "{{ $trans->transmittalStatus_ID }}"
                                                    data-name = "{{ $trans->transmittalStatus_name }}"
                                                    data-desc = "{{ $trans->transmittalStatus_desc }}"
                                                    onclick= "
                                                    document.getElementById('id').value = $(this).data('id');
                                                    document.getElementById('atransmittalStatus_name').value = $(this).data('name');
                                                    document.getElementById('atransmittalStatus_desc').value = $(this).data('desc');
                                                    ">
                ...
                <div class="modal-dialog animated zoomInLeft active" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-add">
                            <h4><br/>Add Transmittal Status</h4>
                        </div><br/><br/>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-12">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input id = "transmittalStatus_name" name = "transmittalStatus_name" type="text" class="form-control" required>
                                                        <label class="form-label">Transmittal Status Name </label>
                                                    </div>
                                                    <div class="help-info">Ex.: Processing, On hold, etc.</div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input id = "transmittalStatus_desc" name = "transmittalStatus_desc" type="text" class="form-control" required>
                ...
                <div class="modal-dialog animated zoomInRight active" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-view">
                            <h4><br/>Transmittal Status Details
                            </h4>
                        </div><br/>
                        ...
                        $('#schange').show();
                        $('#acheckStatus_name').prop('disabled', false);
                        $('#acheckStatus_desc').prop('disabled', false);
                        ...
                        $('#schange').show();
                        $('#aqstat_name').prop('disabled', false);
                        $('#aqstat_desc').prop('disabled', false);
                                  ...
                                  <input id = "id" type="text" class="form-control" name="id" pattern="[A-Za-z'-]">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-12">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                    <label><small>Transmittal Status Name :</small></label>
                                                        <input id = "atransmittalStatus_name" name = "atransmittalStatus_name" type="text" class="form-control" disabled="disable" required>
                                                    </div>
                                                </div>
                                        </div>
                                         ...
                                         <div class="col-md-12">
                                                <div class="form-group form-float">
                                                    ...
                                                    <label><small>Description :</small></label>
                                                        <input id = "atransmittalStatus_desc" name = "atransmittalStatus_desc" type="text" class="form-control" disabled="disable" required>
                                                    </div>
                                                </div>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer js-sweetalert">
                            <button id = "schange" class="btn btn-primary waves-effect" type="submit" style = "display: none;" onclick = "document.getElementById('atime').value = formatDate(new Date());">SAVE CHANGES</button>
                            <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                        </div>
                    </form>
                    </div>
