...
<head>
    ...
    <title>Maintenance - Sales Agent | CIMIS</title>
    <!-- Favicon-->
                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable animated lightSpeedIn active">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" id="{{$agentdata->agent_ID}}" class="filled-in chk-col-red checkCheckbox"/>
            ...
            <div class="modal fade" id="largeModal" tabindex="-1" role="dialog">
                <div class="modal-dialog modal-lg animated zoomInRight active" role="document">
                    <div class="modal-content">
                        ...
                        onclick = "
                        document.getElementById('emp_view').action = 'Sales Agent/update';
                        ...
                        onclick = "
                        document.getElementById('emp_view').action = 'Sales Agent/delete';
                                ...
                                <div class="body">
                                    <form action="/" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
                                        <div class="dz-message">
                                            ...
                                            <em>(You can also drag Sales Agent's image here.)</em>
                                        </div>
                                        <div class="fallback">
                ...
                <div class="modal-dialog modal-lg animated zoomInLeft active" role="document">
                    <div class="modal-content">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            ...
                            <form id="emp_add" name = "emp_add" action = "salesagent/submit" method="POST">
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        ...
                        <div class="modal-footer js-sweetalert">
                            ...
                            onclick = "document.getElementById('time').value = formatDate(new Date());">SUBMIT</button>
                            <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                        </div>
                     </form>
                    </div>
