...
<head>
    ...
    <title>Maintenance - Vehicle Model | CIMIS</title>
                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td><input type="checkbox" id="{{ $mod->vehicle_model_ID }}" class="filled-in chk-col-red"/>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <label><small>Vehicle Make :</small></label>
                                            <select id = "make_name" name = "make_name" class="form-control show-tick" data-live-search="true" >
                                              <option disabled selected value = "null">-- Select Vehicle Make --</option>
                                              @foreach($make as $mke)
                                              @if($mke->del_flag == 0)
