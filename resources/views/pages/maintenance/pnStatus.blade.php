...
<head>
    ...
    <title>Maintenance - Policy Number Status | CIMIS</title>
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                ...
                                <button type="button" class="btn bg-blue waves-effect" data-toggle="modal" data-target="#addModal">
                                    ...
                                    <span>Add Policy Number Status</span>
                                </button>
                                </li>
                                <li>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example animated lightSpeedIn active">
                                ...
                                <tbody>
                                      <?php
                                        $index = 1;
                                      ?>
                                      @foreach($policystat as $pstat)
                                      @if($pstat->del_flag == 0)
                                          <tr>
                                              <td><input type="checkbox" id="{{ $pstat->policyStatus_ID }}" name = "del_check" class="filled-in chk-col-red checkCheckbox"/>
                                              <label for="{{ $pstat->policyStatus_ID }}"></label></td>
                                              <td>{{ $pstat->policyStatus_name }}</td>
                                              <td>{{ \Carbon\Carbon::parse($pstat->created_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($pstat->created_at)->format('l, h:i:s A').")" }}</td>
                                              <td>{{ \Carbon\Carbon::parse($pstat->updated_at)->format('M-d-Y') }} <br/> {{ "(".\Carbon\Carbon::parse($pstat->updated_at)->format('l, h:i:s A').")" }}</td>
                                              <td>
                                                <div class="icon-button-demo">
                                                    <button type="button" class="btn bg-light-blue waves-effect" data-toggle="modal" data-target="#largeModal"
                                                    data-id = "{{ $pstat->policyStatus_ID }}"
                                                    data-name = "{{ $pstat->policyStatus_name }}"
                                                    data-desc = "{{ $pstat->policyStatus_desc }}"
                                                    onclick= "
                                                    document.getElementById('id').value = $(this).data('id');
                                                    document.getElementById('apolicyStatus_name').value = $(this).data('name');
                                                    document.getElementById('apolicyStatus_desc').value = $(this).data('desc');
                                                    ">
                ...
                <div class="modal-dialog animated zoomInLeft active" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-add">
                            <h4><br/>Add Policy Number Status</h4>
                        </div><br/><br/>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-12">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input id = "policyStatus_name" name = "policyStatus_name"  type="text" class="form-control" required>
                                                        <label class="form-label">Policy Number Status Name </label>
                                                    </div>
                                                    <div class="help-info">Ex.: Available, Spoiled, Used, etc.</div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input id = "policyStatus_desc" name = "policyStatus_desc"  type="text" class="form-control" required>
                ...
                <div class="modal-dialog animated zoomInRight active" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-view">
                            <h4><br/>Policy Number Status Details
                            </h4>
                        </div><br/>
                        ...
                        $('#schange').show();
                        $('#apolicyStatus_name').prop('disabled', false);
                        $('#apolicyStatus_desc').prop('disabled', false);
                                  ...
                                  <input id = "id" type="text" class="form-control" name="id" pattern="[A-Za-z'-]">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-12">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                    <label><small>Policy Number Status Name :</small></label>
                                                        <input id = "apolicyStatus_name" name = "apolicyStatus_name" type="text" class="form-control" disabled="disable" required>
                                                    </div>
                                                </div>
                                        </div>
                                         ...
                                         <div class="col-md-12">
                                                <div class="form-group form-float">
                                                    ...
                                                    <label><small>Description :</small></label>
                                                        <input id = "apolicyStatus_desc" name = "apolicyStatus_desc" type="text" class="form-control" disabled="disable" required>
                                                    </div>
                                                </div>
                                        </div>
                                    </div>
