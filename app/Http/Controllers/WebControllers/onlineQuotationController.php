...
{
    public function __construct(quotationListConnection $list,quotationIndividualConnection $indi,quotationCompanyConnection $comp, accListQuoteConnection $alist)
    {
        $this->quote = $list;
    ...
    public function index()
    {
    	...
    	->with('premiumdg', premiumDGConnection::alL())
    	->with('premiumpa', premiumPAConnection::all())
    	->with('salesagent', salesAgentConnection::all());
    }
  ...
  public function add_quote_indi_temp($req)
  {
    ...
    $this->quote_indi->sales_agent = $req->indi_sales;
    $this->quote_indi->insurance_company = $req->insurance_company;
    ...
    $this->quote_indi->pinfo_cpnum_1 = $req->indi_cp_1;
    $this->quote_indi->pinfo_cpnum_2 = $req->indi_cp_2;
    ...
    $this->quote_indi->add_blcknum = $req->indi_blk;
    $this->quote_indi->add_street = $req->indi_street;
    $this->quote_indi->add_subdivision = $req->indi_subdivision;
  ...
  public function add_quote_comp_temp($req)
  {
    ...
    $this->quote_comp->insurance_company = $req->insurance_company;
    ...
    $this->quote_comp->add_blcknum = $req->comp_blk;
    $this->quote_comp->add_street = $req->comp_street;
    $this->quote_comp->add_subdivision = $req->comp_subdivision;
  ...
  {
    $latest = quotationListConnection::orderBy('quote_ID', 'desc')->first();
    $this->list->account_ID = Session::get('accountID');
    $this->list->quote_ID = $latest->quote_ID;
